...
class CreateCommunicationCallRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('communicationCallRecords', function (Blueprint $table) {
            $table->id();
            ...
            $table->bigInteger('callStatusId')->unsigned();
            $table->foreign('callStatusId')->references('id')->on('globalCodes')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('communication_call_records');
    }
}
