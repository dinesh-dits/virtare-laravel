...
class CreateDocumentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('documents', function (Blueprint $table) {
            ...
            $table->string('name');
            $table->text('filePath');
            $table->bigInteger('documentTypeId')->unsigned();
            $table->foreign('documentTypeId')->references('id')->on('globalCodes')->onDelete('cascade')->onUpdate('cascade');
            $table->bigInteger('referanceId')->unsigned();
