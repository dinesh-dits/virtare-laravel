...
class CreateVitalTypeFieldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vitalTypeFields', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
    ...
    {
        Schema::dropIfExists('vital_type_fields');
    }
}
