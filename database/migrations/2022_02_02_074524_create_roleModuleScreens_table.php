...
class CreateRoleModuleScreensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('roleModuleScreens', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
            ...
            $table->bigInteger('roleModuleId')->unsigned()->nullable();
            $table->foreign('roleModuleId')->references('id')->on('roleModules')->onDelete('cascade')->onUpdate('cascade');
            $table->bigInteger('screenId')->unsigned()->nullable();
            $table->foreign('screenId')->references('id')->on('screens')->onDelete('cascade')->onUpdate('cascade');
            $table->string('description',150)->nullable();
            $table->boolean('screenAccess');
    ...
    {
        Schema::dropIfExists('roleModuleScreens');
    }
}
