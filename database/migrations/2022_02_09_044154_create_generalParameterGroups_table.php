...
class CreateGeneralParameterGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('generalParameterGroups', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
            $table->string('name');
    ...
    {
        Schema::dropIfExists('general_parameter_tabble');
    }
}
