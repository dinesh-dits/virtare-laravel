...
class AlterProcedureInventoryList extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure = "CREATE PROCEDURE `inventoryList`(IN isAvailable TINYINT,IN deviceType INT)
        BEGIN
    ...
    {
        Schema::dropIfExists('inventoryList_procedure');
    }
}
