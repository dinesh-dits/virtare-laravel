...
class CreateTableForExportsReportRequests extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exportReportRequest', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
            $table->string('userId');
    ...
    {
        Schema::dropIfExists('exportReportRequest');
    }
}
