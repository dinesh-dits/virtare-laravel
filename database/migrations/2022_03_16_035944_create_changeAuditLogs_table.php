...
class CreateChangeAuditLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('changeAuditLogs', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
            $table->bigInteger('patientTimeLogId')->unsigned();
            $table->integer('timeAmount');
            $table->string('note');
