...
class CreateCallRecordTimesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('callRecordTimes', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
            $table->bigInteger('callRecordId')->unsigned();
    ...
    {
        Schema::dropIfExists('call_record_time');
    }
}
