...
class CreateErorrGenerateWithDeviceNewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('errorLogWithDeviceInfo', function (Blueprint $table) {
            $table->id();
            $table->string('udid');
    ...
    {
        Schema::dropIfExists('errorLogWIthDeviceInfo');
    }
}
