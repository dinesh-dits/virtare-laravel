...
class CreateAddQuestionnaireTagProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        SELECT * FROM tag WHERE questionnaireTagId =LAST_INSERT_ID();  
        END;';
        DB::unprepared($procedure);
    }
    ...
    {
        Schema::dropIfExists('add_questionnaire_tag_procedure');
    }
}
