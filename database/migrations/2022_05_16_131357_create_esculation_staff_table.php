...
class CreateEsculationStaffTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('escalationStaff', function (Blueprint $table) {
            $table->bigIncrements('escalationStaffId');
            $table->string('udid'); 
    ...
    {
        // Schema::dropIfExists('esculation_staff');
    }
}
