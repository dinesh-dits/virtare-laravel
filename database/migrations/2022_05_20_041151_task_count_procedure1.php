...
class TaskCountProcedure1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        WHERE (taskAssignedTo.assignedTo=idx OR idx='') AND (taskAssignedTo.entityType=entity OR entity='') AND tasks.isDelete=0
        GROUP BY
        tasks.taskTypeId ;
        END;";
        DB::unprepared($procedure);
