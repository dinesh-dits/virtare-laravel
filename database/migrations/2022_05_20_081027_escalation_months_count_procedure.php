...
class EscalationMonthsCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `escalationMonthCount`;";
        DB::unprepared($procedure);
        $procedure = "
        CREATE PROCEDURE  escalationMonthCount(IN idx int,IN fromDate VARCHAR(50),IN toDate VARCHAR(50)) 
        BEGIN
