...
class EscalationYearsCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `escalationYearCount`;";
        DB::unprepared($procedure);
        $procedure = "
        CREATE PROCEDURE  escalationYearCount(IN idx int,IN fromDate VARCHAR(50),IN toDate VARCHAR(50)) 
        BEGIN
