...
class PatientReferalWeekCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure = "
        CREATE PROCEDURE  referalWeekCount(IN patientIdx INT,IN fromDate VARCHAR(50),IN toDate VARCHAR(50)) 
        BEGIN
