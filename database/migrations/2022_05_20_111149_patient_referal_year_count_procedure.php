...
class PatientReferalYearCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `referalYearCount`;";
        DB::unprepared($procedure);
        $procedure = "
        CREATE PROCEDURE  referalYearCount(IN patientIdx INT,IN fromDate VARCHAR(50),IN toDate VARCHAR(50)) 
        BEGIN
        ...
        MONTHNAME(patientReferrals.createdAt) as time
        FROM
        referrals
