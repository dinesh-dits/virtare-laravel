...
class TaskWeekCountProcedure1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `taskWeekCount`;";
        DB::unprepared($procedure);
        $procedure = "
        CREATE PROCEDURE  taskWeekCount(IN idx int,IN entity VARCHAR(50),IN fromDate VARCHAR(50),IN toDate VARCHAR(50)) 
        BEGIN
