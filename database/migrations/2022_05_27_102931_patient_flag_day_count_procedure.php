...
class PatientFlagDayCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        WHERE (patientFlags.patientId=patientIdx OR patientIdx='')  AND patientFlags.deletedAt IS NULL AND flags.deletedAt IS NULL AND patients.deletedAt IS NULL
        GROUP BY
        patientFlags.flagId ;
        END;";
        DB::unprepared($procedure);
