...
class GetPatientConditionsCountDailyProcedure1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        WHERE
        patientFlags.deletedAt IS NULL AND patients.deletedAt IS NULL AND (patientFlags.createdAt BETWEEN fromDate AND toDate)
        GROUP BY
        flagId,text,color;
        END;";
