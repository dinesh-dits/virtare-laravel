...
class PatientFlagCountProcedure5 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        WHERE (patientFlags.patientId=patientIdx OR patientIdx='') AND patientFlags.createdAt >= fromDate AND patientFlags.createdAt <= toDate AND
