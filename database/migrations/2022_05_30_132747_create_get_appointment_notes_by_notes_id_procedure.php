...
class CreateGetAppointmentNotesByNotesIdProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `getAppointmentNotesByNotesId`;
        CREATE PROCEDURE `getAppointmentNotesByNotesId`(IN notesID INT)
        BEGIN
        ...
        WHERE notes.id = notesID AND notes.entityType = 'appointment';
        END;";
    ...
    {
        // Schema::dropIfExists('get_appointment_notes_by_notes_id_procedure');
    }
}
