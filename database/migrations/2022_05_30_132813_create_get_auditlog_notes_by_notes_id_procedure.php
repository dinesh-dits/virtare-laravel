...
class CreateGetAuditlogNotesByNotesIdProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure = "DROP PROCEDURE IF EXISTS `getAuditlogNotesByNotesId`;
        CREATE PROCEDURE `getAuditlogNotesByNotesId`(IN notesID INT)
        BEGIN
        ...
        WHERE notes.id = notesID AND notes.entityType = 'auditlog';
        END;";
    ...
    {
        Schema::dropIfExists('get_auditlog_notes_by_notes_id_procedure');
    }
}
