...
class GetPatientConditionsCountProcedure3 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        SELECT(
            ...
            WHERE
            (globalCodes.name='Patient' OR globalCodes.name='Both') AND patientFlags.deletedAt IS NULL AND patients.deletedAt IS NULL  AND patientFlags.createdAt >= fromDate AND patientFlags.createdAt <= toDate  
            GROUP BY
            flagId,text,color;
