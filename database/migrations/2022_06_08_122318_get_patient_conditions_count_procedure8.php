...
class GetPatientConditionsCountProcedure8 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        SELECT(
            ...
            WHERE 
            (globalCodes.name='Patient' OR globalCodes.name='Both') AND patients.deletedAt IS NULL  AND (patientFlags.createdAt >=fromDate OR patientFlags.deletedAt IS NULL)  
            GROUP BY 
            flagId,text,color;
        END;";
