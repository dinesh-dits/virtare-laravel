...
class VitalRangeFlagProcedure extends Migration
{
    /**
     * Run the migrations.
     *
   ...
   RIGHT JOIN vitalFlags ON vitalFieldRanges.vitalFlagId =  vitalFlags.id
    WHERE vitalFields.id = vitalFieldIdx AND vitalFieldRanges.low <= valueNumber AND vitalFieldRanges.high >= valueNumber;
