...
class SearchProcedure extends Migration
{
    ...
    public function up()
    {
        ...
        staffs.lastName AS lastName, staffs.phoneNumber AS phoneNumber, users.email AS email, users.roleId AS type,'' AS middleName 
        FROM
        staffs
        ...
        OR (CONCAT(staffs.lastName, ' ', staffs.firstName))  LIKE CONCAT('%', search ,'%') 	OR(staffs.phoneNumber LIKE CONCAT('%', search ,'%')) OR(users.email LIKE CONCAT('%', search ,'%'))
        UNION
        ...
        patients.lastName AS lastName, patients.phoneNumber AS phoneNumber, users.email AS email, users.roleId AS type, patients.middleName AS middleName
        FROM
        patients
	    ...
	    OR (CONCAT(patients.lastName, ' ', patients.middleName, ' ', patients.firstName)) LIKE CONCAT('%', search ,'%') OR(patients.phoneNumber LIKE CONCAT('%', search ,'%')) OR(users.email LIKE CONCAT('%', search ,'%')) ;
        END;";
        DB::unprepared($search);
    }
