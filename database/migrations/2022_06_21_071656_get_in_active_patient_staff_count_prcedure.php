...
class GetInActivePatientStaffCountPrcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure =
        "CREATE PROCEDURE `getInActivePatientStaffCount`(IN idx INT)
        BEGIN
        SELECT
    ...
    {
        Schema::table('active_patient_staff_count_prcedure', function (Blueprint $table) {
            //
        });
    }
}
