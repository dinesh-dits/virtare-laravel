...
class TaskPriorityCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure =
            "CREATE PROCEDURE `taskPriorityCount`(fromDate VARCHAR(50),toDate VARCHAR(50))
        BEGIN
...
WHERE (tasks.dueDate>=fromDate OR fromDate='') AND (tasks.dueDate<=toDate OR toDate='') AND
