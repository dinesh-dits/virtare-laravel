...
class AlterGetAssignedClientQuestionnaireProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        LEFT JOIN clientQuestionnaireTemplates as cq ON cq.referenceId = cqt.referenceId AND cq.entityType = '246' AND cq.clientQuestionnaireAssignId = cqt.clientQuestionnaireAssignId
        ...
        LEFT JOIN clientQuestionnaireTemplates as cq ON cq.referenceId = cqt.referenceId AND cq.entityType = '247' AND cq.clientQuestionnaireAssignId = cqt.clientQuestionnaireAssignId
