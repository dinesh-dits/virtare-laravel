...
class ReferalCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure = "
        CREATE PROCEDURE  referalCount(IN patientIdx INT,IN fromDate VARCHAR(50),IN toDate VARCHAR(50),IN providerId INT,IN providerLocationId INT) 
        BEGIN
        ...
        hour(patientReferrals.createdAt) as time
        FROM
        referrals
