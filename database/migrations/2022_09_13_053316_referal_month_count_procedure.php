...
class ReferalMonthCountProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure = "
        CREATE PROCEDURE  referalMonthCount(IN patientIdx INT,IN fromDate VARCHAR(50),IN toDate VARCHAR(50),IN providerId INT, IN providerLocationId INT) 
        BEGIN
