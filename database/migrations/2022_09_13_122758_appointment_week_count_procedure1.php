...
class AppointmentWeekCountProcedure1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure =
            "CREATE PROCEDURE `appointmentWeekCount`(IN fromDate VARCHAR(50),IN toDate VARCHAR(50),IN idx INT,IN providerId INT, IN providerLocationId INT)
            BEGIN
