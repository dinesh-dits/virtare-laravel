...
class VitalRangeFlagProcedure2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    BEGIN
    SELECT vitalFields.name AS vitalFieldName , vitalFlags.name AS flagName,vitalFlags.color AS vitalColor, vitalFlags.id AS vitalFlagId, vitalFieldRanges.flagId AS flagId
