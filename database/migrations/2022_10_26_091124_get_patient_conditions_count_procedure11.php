...
class GetPatientConditionsCountProcedure11 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        AND patients.deletedAt IS NULL AND (patientFlags.createdAt >=fromDate AND patientFlags.deletedAt IS NULL) 
