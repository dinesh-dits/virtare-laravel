...
class CreateGetAssignedClientQuestionnaireUpdateProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        LEFT JOIN clientFillUpQuestionnaire as cq ON cq.referenceId = cqt.referenceId AND cq.entityType = '246' AND cq.clientQuestionnaireAssignId = cqt.clientQuestionnaireAssignId
    ...
    {
        // Schema::dropIfExists('get_assigned_client_questionnaire_update_procedure');
    }
}
