...
class CreateGetQuestionnaireResponseUpdateProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        WHERE cqt.clientFillUpQuestionnaireId = qTemplateId;
        END;';
        DB::unprepared($procedure);
    }
    ...
    {
        Schema::dropIfExists('get_questionnaire_response_update_procedure');
    }
}
