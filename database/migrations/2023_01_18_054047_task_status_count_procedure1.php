...
class TaskStatusCountProcedure1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $procedure =
            "CREATE PROCEDURE `taskStatusCount`(IN dueDate VARCHAR(50))
        BEGIN
        ...
        WHERE globalCodes.globalCodeCategoryId = 5 AND tasks.deletedAt IS NULL AND tasks.dueDate >= dueDate
