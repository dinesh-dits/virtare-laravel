...
class ChangeCreateInventories extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        (providerId,udid,deviceModelId,deviceId,networkId,manufactureId,macAddress,serialNumber,isActive,createdBy) 
        values(
        JSON_UNQUOTE(JSON_EXTRACT(data, "$.providerId")),
        JSON_UNQUOTE(JSON_EXTRACT(data, "$.udid")),
        JSON_UNQUOTE(JSON_EXTRACT(data, "$.deviceModelId")),
        JSON_UNQUOTE(JSON_EXTRACT(data, "$.deviceId")),
